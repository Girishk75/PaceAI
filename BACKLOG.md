...
| B5 | GCT threshold validation and tuning | Firmware | Need straight-path jogging nRF data (130–160 spm) to confirm `GYRO_LIFTOFF=200°/s`. If still bimodal: raise `MIN_STANCE_MS` to 220ms and lower `GYRO_LIFTOFF` to 160°/s. Walking data (B5 data 2026-06-22) is not sufficient. |
